...
def _construct_matrix_impl(getkey, cond_cutoff, tags, size, dtype=jnp.float32):
    while True:
...
def construct_matrix(getkey, solver, tags, num=1, *, size=3, dtype=jnp.float32):
...
def construct_singular_matrix(getkey, solver, tags, num=1, dtype=jnp.float32):
